(function( $ ) {
	...
	$(document).ready(function(){
			...
			Yes: {
				...
				"I am a travel caregiver": {
					...
					"I did not complete a travel assignment prior": {
						...
						"I cannot provide 5 good references": {
							action: "You cannot provide 5 good references"
						}
					}
				},
				"I am a local caregiver": {
					...
					"My license is not current": {
						action: "Your license is not current"
					}
				}
			},
			No: {
				action: "You are not an RN or CNA"
			}
		}
		...
		async function askQuestion(text){
			...
			await sleep(2500);
			$('.chat_msg_item_admin:last-child .kudu_msg').text(text);
